...
class SiteHeader extends HTMLElement {
    connectedCallback() {
        ...
        this.outerHTML = ''
            ...
            + '        <div class="logo"><a href="/" title="Avalos Arquitectos"><img src="https://avalosarquitectos.com/public/images/logo.jpeg"'
            ...
            + '                </ul>'
            + '                <div class="mobile-nav"><button class="open-mobile-menu" aria-expanded="false" aria-label="Close menu"><img src="https://avalosarquitectos.com/public/images/close.svg"'
            + '                                                                     alt="" width="18"'
            ...
            + '                src="https://avalosarquitectos.com/public/images/hamburger.svg" alt="" width="24" height="24"/></span></button></div>'
            + '        <div class="clear"></div>'
            + '    </div>'
            + '</header>'
            + '<!-------End Header------->';
...
class SiteFooter extends HTMLElement {
    connectedCallback() {
        this.outerHTML = ''
            ...
            + '                    <div class="logo"><a href="/" title="Avalos Arquitectos"><img src="https://avalosarquitectos.com/public/images/logo.svg"'
            ...
            + '                        </ul>'
            + '                    </div>'
            + '                    <div class="footer-item-title"><span lang="en">Jacinto Avalos and potential projects:</span><span lang="es">Jacinto Avalos y proyectos potenciales:</span></div>'
            + '                    <div class="footer-item-links">'
            + '                        <ul class="link-list">'
